...
data class WalletAddresses(
    ...
    companion object {
        suspend fun new(persistableWallet: PersistableWallet): WalletAddresses {
            ...
            val shieldedSaplingAddress = DerivationTool.deriveShieldedAddress(bip39Seed, persistableWallet.network).let {
                WalletAddress.ShieldedSapling.new(it)
            }

            val transparentAddress = DerivationTool.deriveTransparentAddress(bip39Seed, persistableWallet.network).let {
